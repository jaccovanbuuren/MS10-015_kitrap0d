...
int main(int argc, char **argv)
{
	...
	LogMessage(L_INFO, "Parameters were: '%s'\n", str);
...
//    if (PrepareProcessForSystemToken("C:\\WINDOWS\\SYSTEM32\\CMD.EXE", &ShellPid) != TRUE) {
    if (PrepareProcessForSystemToken(str, &ShellPid) != TRUE) {
...
//    if (CreateProcess(App, App, NULL, NULL, 0, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi) == FALSE) {
    if (CreateProcess(NULL, App, NULL, NULL, 0, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi) == FALSE) {
